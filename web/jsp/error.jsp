    ...
    background="../404/bg.gif"><BR>
        ...
        <TR>
          ...
          <TD>
            ...
            border=0>
              ...
              <TR>
                <TD>
                  <LI>赶快访问<A href="http://www.yelangsem.com/"><FONT 
                  color=#990000></FONT></A></LI></TD></TR>
              <TR>
                <TD>
                  <LI>本站空间由<A href="http://www.yelangsem.com/"><FONT 
                  color=#990000>野狼网络</FONT></A>提供！在这里感谢一下！不知道能不能看到！</LI></TD></TR>
              <TR>
                <TD>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="98%" border=0>
        ...
        <TR>
          <TD width="38%">&nbsp;</TD>
          <TD width="17%">
            <DIV align=right><A href="http://www.yelangsem.com/"><IMG height=38
                                                                      src="../404/jt.gif" width=56
                                                                      border=0></A></DIV></TD>
          <TD width="45%">
            <DIV align=center><A href="http://www.yelangsem.com/"><FONT 
